...
function onShowModal(obj, isEventDetail) {
    if (isEventDetail != null) {//not creating. ya3ne view or update
...
function onSubmitForm() {
    if (checkValidation()) {
        var requestData = {// using the VM not the M
            Id: parseInt($("#id").val()),//all fields are from the partial view
            Title: $("#title").val(),
            Description: $("#description").val(),
            StartDate: $("#appointmentDate").val(),
            Duration: $("#duration").val(),
            DoctorId: $("#doctorId").val(),//from index page of appointment
